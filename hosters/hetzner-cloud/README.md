...
3. You won't be able to ssh into your server. You will have to do the following steps by logging in with the Hetzner UI.
    ...
    - Get the URL of the script you created (might look like `https://raw.github.com/fclaeys/nixos-install-scripts/nomad/hosters/hetzner-cloud/nixos-install-hetzner-cloud.sh`).
    - Paste the following command into your console gui `curl -L https://raw.github.com/fclaeys/nixos-install-scripts/nomad/hosters/hetzner-cloud/nixos-install-hetzner-cloud.sh | sudo bash`.
